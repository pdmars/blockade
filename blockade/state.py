...
class BlockadeState(object):
    ...
    def __init__(self,
        ...
        # TODO(pdmars): is this the logic we want?
        # If no base_state_dir specificed put state file in:
        #   CWD/.blockade/
        # If base_state_dir specified put state file in:
        #   base_state_dir/.blockade/
        # If base_state_dir and blockade_id specified put state file in:
        #   base_state_dir/.blockade/blockade_id/
        if base_state_dir:
            self._base_state_dir = base_state_dir
            self._state_dir = os.path.join(base_state_dir, ".blockade")
        else:
            self._base_state_dir = None
            self._state_dir = os.path.join(os.getcwd(), ".blockade")

        if base_state_dir and blockade_id:
